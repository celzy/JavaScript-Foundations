...
// 🏡 Task 1: Variables
/* Create variables for principal, interest rate, and years. Assign them the values 200000, 0.05, and 30 respectively. Create another value called name and give 
it the value of your own name.
*/
    let principal = (200000);
    let intrestRate = (0.05);
    let years = (30);
    // let name = ('Cortez Elzy'); 
...
If your name is `Oscar` mortgageCalculator() should return "Oscar, your monthly rate is 1073.64"*/
    ...
    return console.log(`${name}, your monthly rate is ${result}`);
}
mortgageCalculator(); 
...
/* let function mortgageCalculator(p, i, n) {
    let principal = p;
    let intrestRate = i;
    let years = n;
    let name = ('Cortez Elzy');
...
*/
let variableIntrestRate = function(p, i, n) {
    for (let r = i - 0.05; r < i + 0.05; r += 0.005){
        let principal = p;
        let intrestRate = r*1;
        let rate = r;
        // var creditScore = c;
    ...
    //     } 
        ...
        let monthlyRate = (numerator / denominator);
        let monthlyInterestRate = (intrestRate / 12);
        var result = (Math.round(monthlyRate * 100)/100);
        return result;
    // console.log(`Hi ${name} your monthly rate is ${result}`);
    }
    
}
variableIntrestRate(200000, 0.04, 30);
